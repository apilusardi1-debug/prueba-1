  ...
  return (
    <div className="space-y-3 text-sm">
      ...
      <div className="border-t border-dashed border-gray-200 dark:border-zinc-700 pt-3 mt-1">
        <p className="text-xs font-medium text-amber-600 dark:text-amber-400 mb-2"><IcTxt n="lock" />Datos del propietario de este departamento — uso interno, nunca se muestran en el sitio público</p>
        <div className="grid grid-cols-2 gap-3">
          <div>

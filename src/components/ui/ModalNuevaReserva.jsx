      ...
      <div className="relative bg-white dark:bg-zinc-900 rounded-2xl shadow-2xl dark:shadow-black/60 w-full max-w-lg max-h-[90vh] flex flex-col" onClick={e => e.stopPropagation()}>
        ...
        <form onSubmit={handleSubmit} className="overflow-y-auto flex-1 px-6 py-5 space-y-4">
          ...
          <button type="submit" disabled={guardando}
            className="w-full bg-brand-600 dark:bg-zinc-100 hover:bg-brand-700 dark:hover:bg-zinc-200 disabled:opacity-50 text-white dark:text-zinc-900 font-semibold text-sm py-2.5 rounded-xl transition-colors">

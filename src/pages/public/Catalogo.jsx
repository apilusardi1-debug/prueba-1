        ...
        <div className="flex flex-col sm:flex-row gap-3 mb-8">
          ...
          <div className="flex gap-2 flex-wrap">
            <button
              ...
              style={{ padding: '8px 18px', borderRadius: 999, fontSize: '0.8rem', fontWeight: 600, cursor: 'pointer', transition: 'all 0.15s', border: 'none', background: !destinoFiltro ? '#1C1208' : 'white', color: !destinoFiltro ? '#f9f3e3' : '#1C1208AA', outline: '1.5px solid ' + (!destinoFiltro ? '#1C1208' : '#e8d09a') }}
            >
              {t('catalog_all')}
            </button>
            {destinosUnicos.map((d) => (
              <button
                ...
                style={{ padding: '8px 18px', borderRadius: 999, fontSize: '0.8rem', fontWeight: 600, cursor: 'pointer', transition: 'all 0.15s', border: 'none', background: destinoFiltro === d ? '#1C1208' : 'white', color: destinoFiltro === d ? '#f9f3e3' : '#1C1208AA', outline: '1.5px solid ' + (destinoFiltro === d ? '#1C1208' : '#e8d09a') }}
              >
                {d}
              </button>
            ))}
